    ...
    <div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <a href="/admin/users" className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-emerald-500 transition-colors">
            <h3 className="text-lg font-semibold text-white mb-2">사용자 관리</h3>
            <p className="text-gray-400">사용자 목록을 확인하고 관리합니다</p>
          </a>
        </div>
      </div>
    </div>
