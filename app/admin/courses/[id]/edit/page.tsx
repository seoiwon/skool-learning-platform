...
export default function EditCoursePage() {
  ...
  const fetchCourseData = async () => {
    // Mock data - same as the course detail page
    if (params.id === '1') {
      ...
      const mockData: CourseFormData = {
        title: 'React 완벽 가이드',
        description: 'React.js의 기초부터 고급 기능까지 완벽하게 마스터하는 강의입니다.',
        category: '웹개발',
        level: '중급',
        duration: '10주',
        price: 99000,
        ...
        objectives: [
          'React 기본 개념과 컴포넌트 이해',
          'State와 Props 관리',
          'React Hooks 활용',
          'Context API와 Redux 상태 관리',
          '실무 프로젝트 개발'
        ],
        requirements: [
        ...
        curriculum: [
          {
            ...
            title: 'React 기초',
            lessons: [
              { id: '1-1', title: 'React 소개와 설치', duration: '20:00', preview: true },
              { id: '1-2', title: '첫 번째 컴포넌트', duration: '25:00', preview: true }
            ]
          }
        ]
      }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Here you would typically update the course in database
    console.log('Updating course:', { id: params.id, ...formData })
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-white">강의 수정</h1>
        <Link
          href="/admin/courses"
